...
def predict_emi(input_dict, model_dir):
    ...
    numeric_cols = [
        ...
        "requested_tenure", "debt_to_income", "expense_to_income", "affordability_ratio", "monthly_disposable",
        "instalment_if_approved", "employment_stability", "loan_to_income_ratio", "dependents_ratio"
    ]
